...
module.exports = function (plop) {
  plop.setGenerator('component', {
    ...
    actions: [
      ...
      {
        type: 'add',
        path: path.resolve(__dirname, '../packages/{{kebabCase name}}/src/{{pascalCase name}}.stories.tsx'),
        ...
        templateFile: path.resolve(__dirname, '../templates/package-ts/scripts/getRollupConfig.hbs'),
      },
			{
        type: 'add',
