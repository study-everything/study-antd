(function (global, factory) {
	...
	var uncurryThis$j = NATIVE_BIND$3 && bind$4.bind(call$9, call$9);
	...
	var getBuiltIn$9 = function (namespace, method) {
	  return arguments.length < 2 ? aFunction(path$9[namespace]) || aFunction(global$t[namespace])
	    : path$9[namespace] && path$9[namespace][method] || global$t[namespace] && global$t[namespace][method];
	};
	...
	var isSymbol$6 = USE_SYMBOL_AS_UID$1 ? function (it) {
	  ...
	  return isCallable$c($Symbol) && isPrototypeOf$1($Symbol.prototype, Object$6(it));
	};
	...
	var store$3 = global$m[SHARED] || setGlobal(SHARED, {});
	...
	*/
	var _export = function (options, source) {
	  ...
	  var target = GLOBAL ? path$8 : path$8[TARGET] || createNonEnumerableProperty$4(path$8, TARGET, {})[TARGET];
	  ...
	  for (key in source) {
	    ...
	    if (options.bind && USE_NATIVE) resultProperty = bind$2(sourceProperty, global$f);
	    ...
	    if (PROTO) {
	      ...
	      if (!hasOwn$a(path$8, VIRTUAL_PROTOTYPE)) {
	        createNonEnumerableProperty$4(path$8, VIRTUAL_PROTOTYPE, {});
	      }
	      // export virtual prototype methods
	      createNonEnumerableProperty$4(path$8[VIRTUAL_PROTOTYPE], key, sourceProperty);
	...
	$$c({ target: 'Reflect', stat: true, forced: FORCED$2, sham: FORCED$2 }, {
	...
	var construct$1 = path$7.Reflect.construct;

	var parent$j = construct$1;

	var construct = parent$j;
	...
	// https://tc39.es/ecma262/#sec-object.defineproperty
	// eslint-disable-next-line es-x/no-object-defineproperty -- safe
	$$b({ target: 'Object', stat: true, forced: Object.defineProperty !== defineProperty$8, sham: !DESCRIPTORS$4 }, {
	...
	var parent$i = defineProperty$9.exports;

	var defineProperty$6 = parent$i;

	var parent$h = defineProperty$6;

	var defineProperty$5 = parent$h;

	var parent$g = defineProperty$5;
	...
	var parent$f = create$5;

	var create$4 = parent$f;
