...
function PickerPanel<DateType>(props: PickerPanelProps<DateType>) {
  ...
  const pickerProps = {
    ...(restProps as MergedPickerPanelProps<DateType>),
    ...
    >
      <div
        ...
        className={classNames(`${prefixCls}-panel`, className, {
          ...
          [`${prefixCls}-panel-has-range-hover`]: hoverRangedValue && hoverRangedValue[0] && hoverRangedValue[1],
