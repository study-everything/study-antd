...
storiesOf('Steps', module).add('Demo', () => (
	<Steps current={1} status="error">
	<Step title="first" subTitle="ddd"  description={description} icon={<Icon type="cloud" />} />
	<Step title="second" />
	<CustomStep title="进行中" description={description} />
	<Step title="third"  description={description}/>
</Steps>
))
.add('demo1', () => (
	<Steps current={1} status="error" icons={icons} type="navigation">
